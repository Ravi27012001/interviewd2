...
showDetails.apply(employee1,[1,"A"]);
showDetails.apply(employee1,[2,"B"]);
showDetails.apply(employee1,[3,"c"]);
...
let em1 = new Employee("Ravi","B.tech","CUH");
let em2 = new Developer("Saurav","B.tech","CUH","fullstack developer");

em1.prototype.college="CUH";
console.log(em1);
console.log(em2);
...
let emp = new Employe("yash","B.tech","CUH");
let empl = new Employe("dipu","B.tech","CUH");